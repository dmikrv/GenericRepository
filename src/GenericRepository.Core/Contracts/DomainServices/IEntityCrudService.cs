...
namespace GenericRepository.Core.Contracts.DomainServices;
...
public interface IEntityCrudService<TPrimaryKey> : IEntityCrudService<TPrimaryKey, TPrimaryKey>
...
public interface IEntityCrudService<TPrimaryKey, in TCreateCommand, in TUpdateCommand, TListResponse, TDetailedResponse> :
    IEntityCrudService<TPrimaryKey, TCreateCommand, TUpdateCommand, TListResponse, TDetailedResponse, ListItem<TPrimaryKey>>
    where TPrimaryKey : IEquatable<TPrimaryKey>;
